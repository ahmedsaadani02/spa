...
const { setCurrentUser, clearCurrentUser, toAppUser, hasPermission } = require('../electron/main-process/auth/session');
const { getEmployeeAuthRowById } = require('../electron/main-process/db/employees');
const { registerAuthHandlers } = require('../electron/main-process/ipc/auth');
const { registerClientsHandlers } = require('../electron/main-process/ipc/clients');
const { registerInvoicesHandlers } = require('../electron/main-process/ipc/invoices');
const { registerQuotesHandlers } = require('../electron/main-process/ipc/quotes');
const { registerProductsHandlers } = require('../electron/main-process/ipc/products');
const { registerStockHandlers } = require('../electron/main-process/ipc/stock');
const { registerMovementsHandlers } = require('../electron/main-process/ipc/movements');
const { registerInventoryHandlers } = require('../electron/main-process/ipc/inventory');
const { registerEmployeesHandlers } = require('../electron/main-process/ipc/employees');
const { registerSalaryHandlers } = require('../electron/main-process/ipc/salary');
const { resolveProductImageUrl, getProductsImagesDirectory } = require('../electron/main-process/product-images');
...
function startServer(port = 3000, host = '0.0.0.0') {
  ...
  httpServer = app.listen(port, host, () => {
    ...
    console.log('Server started from Electron');
  });
