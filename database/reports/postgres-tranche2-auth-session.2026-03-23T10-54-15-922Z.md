...
- Status: `completed`
- Started at: `2026-03-23T10:54:11.360Z`
- Finished at: `2026-03-23T10:54:15.922Z`
- DB driver forced for audit: `postgres`
- Active PostgreSQL scopes: `clients, employees, salary, auth-security`
- Base URL: `http://127.0.0.1:49221`
...
- POST /api/auth/login owner: ok (token=83f2b591...)
- GET /api/auth/me: ok (userId=tranche2-owner-mn32j2jj)
- GET /api/auth/permissions/manageEmployees: ok
- GET /api/clients with PostgreSQL-backed session: ok (count=4)
- POST /api/auth/reset-password: ok (employeeId=tranche2-employee-mn32j2jj)
- POST /api/auth/login employee after reset: ok (token=e6e905eb...)
- GET /api/auth/me employee: ok (userId=tranche2-employee-mn32j2jj)

## Data Checks

- employees.last_login_at owner: ok (Mon Mar 23 2026 11:54:13 GMT+0100 (Central European Standard Time))
- employees.last_login_at employee: ok (Mon Mar 23 2026 11:54:14 GMT+0100 (Central European Standard Time))
