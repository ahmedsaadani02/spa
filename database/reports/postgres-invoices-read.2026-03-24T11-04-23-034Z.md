...
- Status: `completed`
- Started at: `2026-03-24T11:04:15.864Z`
- Finished at: `2026-03-24T11:04:23.033Z`
- SQLite source kept: `C:\Users\Ahmed Saadani\AppData\Roaming\spa-invoice-desktop\spa.db`
- SQLite audit copy used by local runtime: `C:\Users\Ahmed Saadani\Desktop\spa-test\database\tmp\invoices-read-audit.2026-03-24T11-04-15-432Z.sqlite`
- DB driver forced for audit: `postgres`
- Active PostgreSQL scopes: `clients, employees, salary, auth-security, invoices-read`
- Base URL: `http://127.0.0.1:55630`
...
- POST /api/auth/login: ok (token=113b35a2...)
...
- clients table unchanged during reads: ok (count=4)
