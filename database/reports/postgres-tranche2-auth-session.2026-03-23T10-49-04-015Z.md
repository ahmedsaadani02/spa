...
- Status: `completed`
- Started at: `2026-03-23T10:48:59.108Z`
- Finished at: `2026-03-23T10:49:04.014Z`
- DB driver forced for audit: `postgres`
- Active PostgreSQL scopes: `clients, employees, salary, auth-security`
- Base URL: `http://127.0.0.1:65494`
...
- POST /api/auth/login owner: ok (token=d962c2c3...)
- GET /api/auth/me: ok (userId=tranche2-owner-mn32cdlv)
- GET /api/auth/permissions/manageEmployees: ok
- GET /api/clients with PostgreSQL-backed session: ok (count=4)
- POST /api/auth/reset-password: ok (employeeId=tranche2-employee-mn32cdlv)
- POST /api/auth/login employee after reset: ok (token=c6c97074...)
- GET /api/auth/me employee: ok (userId=tranche2-employee-mn32cdlv)

## Data Checks

- employees.last_login_at owner: ok (Mon Mar 23 2026 11:49:01 GMT+0100 (Central European Standard Time))
- employees.last_login_at employee: ok (Mon Mar 23 2026 11:49:02 GMT+0100 (Central European Standard Time))
