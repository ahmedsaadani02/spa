...
- Status: `completed`
- Started at: `2026-03-24T11:27:55.907Z`
- Finished at: `2026-03-24T11:28:03.789Z`
- SQLite source kept: `C:\Users\Ahmed Saadani\AppData\Roaming\spa-invoice-desktop\spa.db`
- SQLite audit copy used by local runtime: `C:\Users\Ahmed Saadani\Desktop\spa-test\database\tmp\invoices-write-audit.2026-03-24T11-27-55-432Z.sqlite`
...
- POST /api/auth/login: ok (token=3d239d41...)
- POST /api/invoices: ok (invoice=invoices-write-audit-mn4j6bcx)
- PUT /api/invoices/:id: ok (invoice=invoices-write-audit-mn4j6bcx)
- GET /api/invoices/:id: ok (invoice=invoices-write-audit-mn4j6bcx)
- GET /api/invoices: ok (count=7)

## Parity Checks

- invoice getById parity after create/update: ok (invoice=invoices-write-audit-mn4j6bcx)
- invoices list parity after create/update: ok (count=7)
- stored invoices row parity: ok (invoice=invoices-write-audit-mn4j6bcx)
