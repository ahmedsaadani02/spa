...
- Status: `completed`
- Started at: `2026-03-24T13:43:19.858Z`
- Finished at: `2026-03-24T13:43:35.329Z`
- SQLite source kept: `C:\Users\Ahmed Saadani\AppData\Roaming\spa-invoice-desktop\spa.db`
- SQLite audit copy used by local runtime: `C:\Users\Ahmed Saadani\Desktop\spa-test\database\tmp\invoices-delete-audit.2026-03-24T13-43-19-464Z.sqlite`
...
- POST /api/auth/login: ok (token=2760a891...)
...
- scenario A delete result parity: ok (quote=invoices-delete-quote-a-mn4o0fua)
- scenario A quote reopened to draft parity: ok (quote=invoices-delete-quote-a-mn4o0fua)
- scenario B delete result parity: ok (quote=invoices-delete-quote-b-mn4o0fua)
- scenario B quote redirected to replacement invoice parity: ok (quote=invoices-delete-quote-b-mn4o0fua)

## Scope Checks

- scenario A linked invoice removed: ok (count=0 after delete)
- scenario B remaining invoice preserved: ok (invoice=invoices-delete-extra-mn4o0fua)
