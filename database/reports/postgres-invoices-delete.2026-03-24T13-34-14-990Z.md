...
- Status: `completed`
- Started at: `2026-03-24T13:34:02.281Z`
- Finished at: `2026-03-24T13:34:14.989Z`
- SQLite source kept: `C:\Users\Ahmed Saadani\AppData\Roaming\spa-invoice-desktop\spa.db`
- SQLite audit copy used by local runtime: `C:\Users\Ahmed Saadani\Desktop\spa-test\database\tmp\invoices-delete-audit.2026-03-24T13-34-02-010Z.sqlite`
...
- POST /api/auth/login: ok (token=db8fca73...)
...
- scenario A delete result parity: ok (quote=invoices-delete-quote-a-mn4nohm1)
- scenario A quote reopened to draft parity: ok (quote=invoices-delete-quote-a-mn4nohm1)
- scenario B delete result parity: ok (quote=invoices-delete-quote-b-mn4nohm1)
- scenario B quote redirected to replacement invoice parity: ok (quote=invoices-delete-quote-b-mn4nohm1)

## Scope Checks

- scenario A linked invoice removed: ok (count=0 after delete)
- scenario B remaining invoice preserved: ok (invoice=invoices-delete-extra-mn4nohm1)
