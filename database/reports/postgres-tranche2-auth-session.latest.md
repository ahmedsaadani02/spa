...
- Status: `completed`
- Started at: `2026-03-24T13:41:43.140Z`
- Finished at: `2026-03-24T13:41:47.688Z`
- DB driver forced for audit: `postgres`
- Active PostgreSQL scopes: `clients, employees, salary, auth-security`
- Base URL: `http://127.0.0.1:59331`
...
- POST /api/auth/login owner: ok (token=1ce8edb3...)
- GET /api/auth/me: ok (userId=tranche2-owner-mn4nyd7n)
- GET /api/auth/permissions/manageEmployees: ok
- GET /api/clients with PostgreSQL-backed session: ok (count=8)
- POST /api/auth/reset-password: ok (employeeId=tranche2-employee-mn4nyd7n)
- POST /api/auth/login employee after reset: ok (token=32b382f9...)
- GET /api/auth/me employee: ok (userId=tranche2-employee-mn4nyd7n)

## Data Checks

- employees.last_login_at owner: ok (Tue Mar 24 2026 14:41:44 GMT+0100 (Central European Standard Time))
- employees.last_login_at employee: ok (Tue Mar 24 2026 14:41:46 GMT+0100 (Central European Standard Time))
