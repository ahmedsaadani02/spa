...
- Status: `completed`
- Started at: `2026-03-24T13:43:03.826Z`
- Finished at: `2026-03-24T13:43:10.470Z`
- SQLite source kept: `C:\Users\Ahmed Saadani\AppData\Roaming\spa-invoice-desktop\spa.db`
- SQLite audit copy used by local runtime: `C:\Users\Ahmed Saadani\Desktop\spa-test\database\tmp\invoices-write-audit.2026-03-24T13-43-03-310Z.sqlite`
...
- POST /api/auth/login: ok (token=4a22725b...)
- POST /api/invoices: ok (invoice=invoices-write-audit-mn4o03gw)
- PUT /api/invoices/:id: ok (invoice=invoices-write-audit-mn4o03gw)
- GET /api/invoices/:id: ok (invoice=invoices-write-audit-mn4o03gw)
- GET /api/invoices: ok (count=7)

## Parity Checks

- invoice getById parity after create/update: ok (invoice=invoices-write-audit-mn4o03gw)
- invoices list parity after create/update: ok (count=7)
- stored invoices row parity: ok (invoice=invoices-write-audit-mn4o03gw)
