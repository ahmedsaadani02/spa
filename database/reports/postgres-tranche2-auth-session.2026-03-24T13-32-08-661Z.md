...
- Status: `completed`
- Started at: `2026-03-24T13:32:00.396Z`
- Finished at: `2026-03-24T13:32:08.660Z`
- DB driver forced for audit: `postgres`
- Active PostgreSQL scopes: `clients, employees, salary, auth-security`
- Base URL: `http://127.0.0.1:60025`
...
- POST /api/auth/login owner: ok (token=4998020c...)
- GET /api/auth/me: ok (userId=tranche2-owner-mn4nlvkb)
- GET /api/auth/permissions/manageEmployees: ok
- GET /api/clients with PostgreSQL-backed session: ok (count=8)
- POST /api/auth/reset-password: ok (employeeId=tranche2-employee-mn4nlvkb)
- POST /api/auth/login employee after reset: ok (token=ee699260...)
- GET /api/auth/me employee: ok (userId=tranche2-employee-mn4nlvkb)

## Data Checks

- employees.last_login_at owner: ok (Tue Mar 24 2026 14:32:03 GMT+0100 (Central European Standard Time))
- employees.last_login_at employee: ok (Tue Mar 24 2026 14:32:07 GMT+0100 (Central European Standard Time))
