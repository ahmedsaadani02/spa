...
export const routes = [
    ...
    { path: 'estimation', loadComponent: () => import('./components/estimation/estimation.component').then((m) => m.EstimationComponent), canActivate: [authGuard, permissionGuard], data: { permissions: ['manageQuotes'] } },
    ...
    { path: 'stock/history', loadComponent: () => import('./components/stock-history/stock-history.component').then((m) => m.StockHistoryComponent), canActivate: [authGuard, permissionGuard], data: { permissions: ['viewStock'] } },
    { path: 'inventaire', loadComponent: () => import('./components/inventaire/inventaire.component').then((m) => m.InventaireComponent), canActivate: [authGuard, permissionGuard], data: { permissions: ['viewStock'] } },
