...
export class ClientStorageService {
    ...
    async upsert(client) {
        ...
        const next = this.normalizeStoredClient({
    ...
    async patchMissingFields(client, input) {
        const next = {
            ...client,
        ...
        const changed = ((next.adresse ?? '') !== (client.adresse ?? '') ||
            (next.tel ?? '') !== (client.tel ?? '') ||
            (next.mf ?? '') !== (client.mf ?? '') ||
            (next.email ?? '') !== (client.email ?? ''));
        if (!changed)
            return this.normalizeStoredClient(client);
    ...
    findEquivalentClient(clients, input) {
    ...
    static { this.ɵfac = function ClientStorageService_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || ClientStorageService)(); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: ClientStorageService, factory: ClientStorageService.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ClientStorageService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
