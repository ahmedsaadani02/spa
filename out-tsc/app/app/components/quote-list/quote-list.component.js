...
import * as i1 from "../../services/quote-store.service";
import * as i2 from "../../services/quote-calc.service";
import * as i3 from "@angular/common";
import * as i4 from "@angular/router";
import * as i5 from "@angular/forms";
const _c0 = a0 => ["/quotes", a0, "preview"];
const _c1 = a0 => ["/quotes", a0, "edit"];
function QuoteListComponent_option_12_Template(rf, ctx) { if (rf & 1) {
...
function QuoteListComponent_div_18_div_18_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function QuoteListComponent_div_18_div_18_Template_button_click_20_listener() { const quote_r3 = i0.ɵɵrestoreView(_r2).$implicit; const ctx_r3 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r3.deleteQuote(quote_r3)); });
    i0.ɵɵnamespaceSVG();
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(quote_r3.numero);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(5, 6, quote_r3.date, "dd/MM/yyyy"));
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(quote_r3.client.nom);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", i0.ɵɵpipeBind2(10, 9, ctx_r3.totalHorsTVA(quote_r3), "1.2-2"), " DT");
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("routerLink", i0.ɵɵpureFunction1(12, _c0, quote_r3.id));
    i0.ɵɵadvance(4);
    i0.ɵɵproperty("routerLink", i0.ɵɵpureFunction1(14, _c1, quote_r3.id));
} }
function QuoteListComponent_div_18_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(15, "TOTAL HORS T.V.A");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(16, "div");
    i0.ɵɵtext(17, "Actions");
    i0.ɵɵelementEnd()();
    i0.ɵɵtemplate(18, QuoteListComponent_div_18_div_18_Template, 27, 16, "div", 21);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", group_r5.items.length, " devis");
    i0.ɵɵadvance(13);
    i0.ɵɵproperty("ngForOf", group_r5.items);
} }
function QuoteListComponent_div_20_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 39);
    i0.ɵɵtext(1, " Aucun devis trouv\u00E9. ");
    i0.ɵɵelementEnd();
} }
function QuoteListComponent_ng_container_23_div_17_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r3 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(quote_r6.numero);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(5, 4, quote_r6.date, "dd/MM/yyyy"));
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(quote_r6.client.nom);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", i0.ɵɵpipeBind2(10, 7, ctx_r3.totalHorsTVA(quote_r6), "1.2-2"), " DT");
} }
function QuoteListComponent_ng_container_23_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(16, "TOTAL HORS T.V.A");
    i0.ɵɵelementEnd()();
    i0.ɵɵtemplate(17, QuoteListComponent_ng_container_23_div_17_Template, 11, 10, "div", 45);
    i0.ɵɵelementEnd();
    i0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const printedQuotes_r7 = ctx.ngIf;
    const ctx_r3 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate1("Liste des devis \u2014 ", ctx_r3.selectedMonthLabel);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" Date d\u2019impression : ", i0.ɵɵpipeBind2(6, 3, ctx_r3.printDate, "dd/MM/yyyy HH:mm"), " ");
    i0.ɵɵadvance(12);
    i0.ɵɵproperty("ngForOf", printedQuotes_r7);
} }
function QuoteListComponent_div_25_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function QuoteListComponent_div_25_Template_button_click_5_listener() { i0.ɵɵrestoreView(_r8); const ctx_r3 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r3.closeToast()); });
    i0.ɵɵtext(6, "\u00D7");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r3 = i0.ɵɵnextContext();
...
export class QuoteListComponent {
    constructor(store, calc, cdr) {
        ...
        ]).pipe(map(([quotes, term]) => {
            const query = term.trim().toLowerCase();
            if (!query) {
                return quotes;
            }
            return quotes.filter((quote) => {
                return (quote.numero.toLowerCase().includes(query) ||
                    quote.client.nom.toLowerCase().includes(query));
            });
        }));
        this.baseGroups$ = this.filteredQuotes$.pipe(map((quotes) => {
            const groups = this.buildMonthGroups(quotes);
            this.ensureMonthSelection(groups);
            return groups;
        }));
        this.groupedQuotes$ = combineLatest([
            this.baseGroups$,
        ...
        this.printQuotes$ = combineLatest([
            this.filteredQuotes$,
            this.monthControl.valueChanges.pipe(startWith(this.monthControl.value))
        ]).pipe(map(([quotes, key]) => {
            if (!key || key === 'all') {
    ...
    static { this.ɵfac = function QuoteListComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || QuoteListComponent)(i0.ɵɵdirectiveInject(i1.QuoteStoreService), i0.ɵɵdirectiveInject(i2.QuoteCalcService), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: QuoteListComponent, selectors: [["app-quote-list"]], decls: 26, vars: 17, consts: [[1, "panel", "card", "no-print"], [1, "panel-header"], [1, "panel-actions", "no-print"], ["type", "search", "placeholder", "Rechercher par num\u00E9ro ou client", 1, "input", 3, "formControl"], ["aria-label", "Mois \u00E0 imprimer", 1, "input", 3, "formControl"], ["value", "all"], [3, "value", 4, "ngFor", "ngForOf"], ["type", "button", 1, "btn", "ghost", 3, "click"], ["routerLink", "/quotes/new", 1, "btn", "primary"], ["class", "month-group", 4, "ngFor", "ngForOf"], ["class", "empty", 4, "ngIf"], [1, "print-area"], [4, "ngIf"], ["class", "toast no-print", 4, "ngIf"], [3, "value"], [1, "month-group"], [1, "month-header"], [1, "month-title"], [1, "month-meta"], [1, "table"], [1, "table-row", "table-head"], ["class", "table-row", 4, "ngFor", "ngForOf"], [1, "table-row"], [1, "mono"], [1, "amount"], [1, "actions"], ["aria-label", "Aper\u00E7u", "title", "Aper\u00E7u", 1, "icon-btn", "icon-btn--ghost", 3, "routerLink"], ["viewBox", "0 0 24 24", "aria-hidden", "true"], ["d", "M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"], ["cx", "12", "cy", "12", "r", "3"], ["aria-label", "Modifier", "title", "Modifier", 1, "icon-btn", "icon-btn--outline", 3, "routerLink"], ["d", "M12 20h9"], ["d", "M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"], ["type", "button", "aria-label", "Supprimer", "title", "Supprimer", 1, "icon-btn", "icon-btn--danger", 3, "click"], ["d", "M3 6h18"], ["d", "M8 6V4h8v2"], ["d", "M19 6l-1 14H6L5 6"], ["d", "M10 11v6"], ["d", "M14 11v6"], [1, "empty"], [1, "print-header"], [1, "print-title"], [1, "print-meta"], [1, "print-table"], [1, "print-row", "print-head"], ["class", "print-row", 4, "ngFor", "ngForOf"], [1, "print-row"], [1, "toast", "no-print"], [1, "toast-icon"], [1, "toast-message"], ["type", "button", 1, "toast-close", 3, "click"]], template: function QuoteListComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "section", 0)(1, "div", 1)(2, "div")(3, "h1");
            i0.ɵɵtext(4, "Liste des devis");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(5, "p");
            i0.ɵɵtext(6, "G\u00E9rez l\u2019historique des devis en un coup d\u2019\u0153il.");
            i0.ɵɵelementEnd()();
            ...
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(12, QuoteListComponent_option_12_Template, 2, 2, "option", 6);
            i0.ɵɵpipe(13, "async");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(14, "button", 7);
            i0.ɵɵlistener("click", function QuoteListComponent_Template_button_click_14_listener() { return ctx.printSelectedMonth(); });
            i0.ɵɵtext(15, "Imprimer");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(16, "a", 8);
            i0.ɵɵtext(17, "Nouveau");
            i0.ɵɵelementEnd()()();
            i0.ɵɵtemplate(18, QuoteListComponent_div_18_Template, 19, 3, "div", 9);
            i0.ɵɵpipe(19, "async");
            i0.ɵɵtemplate(20, QuoteListComponent_div_20_Template, 2, 0, "div", 10);
            i0.ɵɵpipe(21, "async");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(22, "section", 11);
            i0.ɵɵtemplate(23, QuoteListComponent_ng_container_23_Template, 18, 6, "ng-container", 12);
            i0.ɵɵpipe(24, "async");
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(25, QuoteListComponent_div_25_Template, 7, 1, "div", 13);
        } if (rf & 2) {
            let tmp_4_0;
            i0.ɵɵadvance(8);
            ...
            i0.ɵɵadvance(6);
            i0.ɵɵproperty("ngForOf", i0.ɵɵpipeBind1(19, 11, ctx.groupedQuotes$));
            i0.ɵɵadvance(2);
            i0.ɵɵproperty("ngIf", ((tmp_4_0 = i0.ɵɵpipeBind1(21, 13, ctx.filteredQuotes$)) == null ? null : tmp_4_0.length) === 0);
            i0.ɵɵadvance(2);
            i0.ɵɵclassProp("print-only", ctx.isPrintMode);
            i0.ɵɵadvance();
            i0.ɵɵproperty("ngIf", i0.ɵɵpipeBind1(24, 15, ctx.printQuotes$));
            i0.ɵɵadvance(2);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(QuoteListComponent, [{
        type: Component,
        args: [{ selector: 'app-quote-list', standalone: true, imports: [CommonModule, RouterModule, ReactiveFormsModule], template: "<section class=\"panel card no-print\">\n  <div class=\"panel-header\">\n    <div>\n      <h1>Liste des devis</h1>\n      <p>G&eacute;rez l&rsquo;historique des devis en un coup d&rsquo;&oelig;il.</p>\n    </div>\n    <div class=\"panel-actions no-print\">\n      <input\n        class=\"input\"\n        type=\"search\"\n        placeholder=\"Rechercher par num&eacute;ro ou client\"\n        [formControl]=\"searchControl\"\n      >\n      <select class=\"input\" [formControl]=\"monthControl\" aria-label=\"Mois &agrave; imprimer\">\n        <option value=\"all\">Tous les mois</option>\n        <option *ngFor=\"let month of monthOptions$ | async\" [value]=\"month.key\">\n          {{ month.label }}\n        </option>\n      </select>\n      <button class=\"btn ghost\" type=\"button\" (click)=\"printSelectedMonth()\">Imprimer</button>\n      <a class=\"btn primary\" routerLink=\"/quotes/new\">Nouveau</a>\n    </div>\n  </div>\n\n  <div class=\"month-group\" *ngFor=\"let group of groupedQuotes$ | async\">\n    <div class=\"month-header\">\n      <div class=\"month-title\">{{ group.label }}</div>\n      <div class=\"month-meta\">{{ group.items.length }} devis</div>\n    </div>\n\n    <div class=\"table\">\n      <div class=\"table-row table-head\">\n        <div>Num&eacute;ro</div>\n        <div>Date</div>\n        <div>Client</div>\n        <div>TOTAL HORS T.V.A</div>\n        <div>Actions</div>\n      </div>\n      <div class=\"table-row\" *ngFor=\"let quote of group.items\">\n        <div class=\"mono\">{{ quote.numero }}</div>\n        <div>{{ quote.date | date:'dd/MM/yyyy' }}</div>\n        <div>{{ quote.client.nom }}</div>\n        <div class=\"amount\">{{ totalHorsTVA(quote) | number:'1.2-2' }} DT</div>\n        <div class=\"actions\">\n          <a\n            class=\"icon-btn icon-btn--ghost\"\n            [routerLink]=\"['/quotes', quote.id, 'preview']\"\n            aria-label=\"Aper&ccedil;u\"\n            title=\"Aper&ccedil;u\"\n          >\n            <svg viewBox=\"0 0 24 24\" aria-hidden=\"true\">\n              <path d=\"M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z\" />\n              <circle cx=\"12\" cy=\"12\" r=\"3\" />\n            </svg>\n          </a>\n          <a\n            class=\"icon-btn icon-btn--outline\"\n            [routerLink]=\"['/quotes', quote.id, 'edit']\"\n            aria-label=\"Modifier\"\n            title=\"Modifier\"\n          >\n            <svg viewBox=\"0 0 24 24\" aria-hidden=\"true\">\n              <path d=\"M12 20h9\" />\n              <path d=\"M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z\" />\n            </svg>\n          </a>\n          <button\n            class=\"icon-btn icon-btn--danger\"\n            type=\"button\"\n            (click)=\"deleteQuote(quote)\"\n            aria-label=\"Supprimer\"\n            title=\"Supprimer\"\n          >\n            <svg viewBox=\"0 0 24 24\" aria-hidden=\"true\">\n              <path d=\"M3 6h18\" />\n              <path d=\"M8 6V4h8v2\" />\n              <path d=\"M19 6l-1 14H6L5 6\" />\n              <path d=\"M10 11v6\" />\n              <path d=\"M14 11v6\" />\n            </svg>\n          </button>\n        </div>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"empty\" *ngIf=\"(filteredQuotes$ | async)?.length === 0\">\n    Aucun devis trouv&eacute;.\n  </div>\n</section>\n\n<section class=\"print-area\" [class.print-only]=\"isPrintMode\">\n  <ng-container *ngIf=\"printQuotes$ | async as printedQuotes\">\n    <div class=\"print-header\">\n      <div class=\"print-title\">Liste des devis &mdash; {{ selectedMonthLabel }}</div>\n      <div class=\"print-meta\">\n        Date d&rsquo;impression : {{ printDate | date:'dd/MM/yyyy HH:mm' }}\n      </div>\n    </div>\n\n    <div class=\"print-table\">\n      <div class=\"print-row print-head\">\n        <div>NUM&Eacute;RO</div>\n        <div>DATE</div>\n        <div>CLIENT</div>\n        <div>TOTAL HORS T.V.A</div>\n      </div>\n      <div class=\"print-row\" *ngFor=\"let quote of printedQuotes\">\n        <div class=\"mono\">{{ quote.numero }}</div>\n        <div>{{ quote.date | date:'dd/MM/yyyy' }}</div>\n        <div>{{ quote.client.nom }}</div>\n        <div class=\"amount\">{{ totalHorsTVA(quote) | number:'1.2-2' }} DT</div>\n      </div>\n    </div>\n  </ng-container>\n</section>\n\n<div class=\"toast no-print\" *ngIf=\"toast.open\">\n  <span class=\"toast-icon\">\u2139\uFE0F</span>\n  <span class=\"toast-message\">{{ toast.message }}</span>\n  <button class=\"toast-close\" type=\"button\" (click)=\"closeToast()\">\u00D7</button>\n</div>\n", styles: [".panel {\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n}\n\n.panel-header {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  gap: 20px;\n}\n\n.panel-actions {\n  display: flex;\n  gap: 12px;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-left: auto;\n  justify-content: flex-end;\n}\n\n.month-group {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n\n.month-header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 12px;\n  padding: 10px 14px;\n  border-radius: 12px;\n  background: #f8f6f1;\n  border: 1px solid var(--border);\n}\n\n.month-title {\n  font-weight: 700;\n  letter-spacing: 0.01em;\n}\n\n.month-meta {\n  color: var(--muted);\n  font-size: 0.85rem;\n}\n\n.table {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n\n.table-row {\n  display: grid;\n  grid-template-columns: 1.2fr 0.8fr 1.2fr 0.9fr 1.3fr;\n  gap: 12px;\n  align-items: center;\n  padding: 12px 0;\n  border-bottom: 1px solid var(--border);\n}\n\n.table-head {\n  text-transform: uppercase;\n  font-size: 0.75rem;\n  letter-spacing: 0.08em;\n  color: var(--muted);\n  border-bottom: 2px solid var(--border);\n  padding-bottom: 10px;\n}\n\n.actions {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n\n.icon-btn {\n  width: 36px;\n  height: 36px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 10px;\n  border: 1px solid var(--border);\n  background: #fff;\n  color: var(--ink);\n  cursor: pointer;\n  transition: background 0.15s ease, transform 0.15s ease, box-shadow 0.15s ease, color 0.15s ease;\n}\n\n.icon-btn svg {\n  width: 18px;\n  height: 18px;\n  fill: none;\n  stroke: currentColor;\n  stroke-width: 1.8;\n  stroke-linecap: round;\n  stroke-linejoin: round;\n}\n\n.icon-btn--ghost {\n  background: #f8f6f1;\n}\n\n.icon-btn--outline {\n  background: #fff;\n}\n\n.icon-btn--danger {\n  background: #fff5f5;\n  border-color: rgba(180, 35, 24, 0.3);\n  color: #b42318;\n}\n\n.icon-btn:hover {\n  background: #111827;\n  color: #fff;\n  transform: translateY(-1px);\n  box-shadow: 0 10px 20px rgba(15, 23, 42, 0.15);\n}\n\n.icon-btn--danger:hover {\n  background: #b42318;\n  color: #fff;\n}\n\n.empty {\n  text-align: center;\n  color: var(--muted);\n  padding: 30px 0 10px;\n}\n\n.print-area {\n  display: none;\n  padding: 12px 0;\n}\n\n.print-area.print-only {\n  display: block;\n}\n\n.print-header {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  padding-bottom: 12px;\n  margin-bottom: 16px;\n  border-bottom: 1px solid #d1d5db;\n}\n\n.print-title {\n  font-size: 1.1rem;\n  font-weight: 700;\n}\n\n.print-meta {\n  font-size: 0.85rem;\n  color: #4b5563;\n}\n\n.print-table {\n  display: grid;\n  gap: 6px;\n}\n\n.print-row {\n  display: grid;\n  grid-template-columns: 1.2fr 0.9fr 1.4fr 0.9fr;\n  gap: 12px;\n  align-items: center;\n  padding: 6px 0;\n  border-bottom: 1px solid #e5e7eb;\n}\n\n.print-head {\n  text-transform: uppercase;\n  font-size: 0.75rem;\n  letter-spacing: 0.08em;\n  font-weight: 700;\n  color: #111827;\n  border-bottom: 2px solid #111827;\n  padding-bottom: 8px;\n}\n\n.toast {\n  position: fixed;\n  right: 24px;\n  bottom: 24px;\n  display: inline-flex;\n  align-items: center;\n  gap: 10px;\n  padding: 10px 14px;\n  border-radius: 12px;\n  background: #111827;\n  color: #fff;\n  box-shadow: 0 16px 30px rgba(15, 23, 42, 0.2);\n  z-index: 80;\n}\n\n.toast-icon {\n  font-size: 1rem;\n}\n\n.toast-message {\n  font-size: 0.9rem;\n  font-weight: 600;\n}\n\n.toast-close {\n  background: transparent;\n  border: none;\n  color: #fff;\n  font-size: 1.1rem;\n  line-height: 1;\n  cursor: pointer;\n  padding: 2px 6px;\n  border-radius: 8px;\n}\n\n.toast-close:hover {\n  background: rgba(255, 255, 255, 0.14);\n}\n\n@media (max-width: 980px) {\n  .panel-header {\n    flex-direction: column;\n  }\n\n  .panel-actions {\n    width: 100%;\n  }\n\n  .table-row {\n    grid-template-columns: 1fr;\n    gap: 8px;\n  }\n}\n\n@page {\n  size: A4;\n  margin: 12mm;\n}\n\n@media print {\n  body {\n    background: #fff;\n  }\n\n  .no-print {\n    display: none !important;\n  }\n\n  .print-area {\n    display: block !important;\n  }\n\n  .card,\n  .table,\n  .table-row {\n    box-shadow: none !important;\n  }\n}\n"] }]
    }], () => [{ type: i1.QuoteStoreService }, { type: i2.QuoteCalcService }, { type: i0.ChangeDetectorRef }], null); })();
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(QuoteListComponent, { className: "QuoteListComponent", filePath: "src/app/components/quote-list/quote-list.component.ts", lineNumber: 25 }); })();
